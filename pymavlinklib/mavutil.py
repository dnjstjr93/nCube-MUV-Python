...
import select
import copy
from pymavlinklib import mavexpression
...
try:
    import json
    from pymavlinklib.dialects.v10 import ardupilotmega
except Exception:
    pass
...
def set_dialect(dialect):
    ...
    if 'MAVLINK20' in os.environ:
        ...
        modname = "pymavlinklib.dialects.v20." + dialect
        ...
        modname = "pymavlinklib.dialects.v10." + dialect
    else:
        wire_protocol = mavparse.PROTOCOL_0_9
        modname = "pymavlinklib.dialects.v09." + dialect
...
def mavlink_connection(device, baud=115200, source_system=255, source_component=0,
    ...
    if device.lower().endswith('.bin') or device.lower().endswith('.px4log'):
        ...
        from pymavlinklib import DFReader
